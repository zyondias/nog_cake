...
<div class="form-right">
    <?php echo $this->Form->input('nome', array('class' => 'span5', 'label' => 'Nome: ', 'placeholder' => 'Fernando Nogueira')) ?>
    <?php echo $this->Form->input('email', array('class' => 'span5', 'label' => 'E-mail: ', 'maxlenght' => '100', 'placeholder' => 'fernando@hotmail.com')) ?>
